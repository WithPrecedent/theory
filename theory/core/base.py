...
Contents:
    SimpleSettings (amos.project.Settings):
    SimpleFiler (amos.project.Filer):
    SimpleManager (amos.project.Manager):
    SimpleComponent (amos.project.Component):
    SimpleAlgorithm
    SimpleCriteria
...
@dataclasses.dataclass
class Component(SimpleBase, amos.quirks.Element, abc.ABC):
...
@dataclasses.dataclass
class Stage(SimpleBase, amos.quirks.Needy, abc.ABC):
