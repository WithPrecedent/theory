...
class Outline(base.Phase):
    ...
    Args:
        name (str): designates the name of a class instance that is used for 
            ...
            amos instance needs settings from a Configuration 
    ...
    def _get_design(cls, name: str, settings: base.Settings) -> str:
        ...
        try:
            ...
            try:
                ...
                try:
                    design = settings['amos']['default_design']
                except KeyError:
    ...
    def _get_structure(cls, name: str, settings: base.Settings) -> str:
        ...
        try:
            ...
            try:
                ...
                try:
                    structure = settings['amos']['default_workflow']
                except KeyError:
...
class Workflow(base.Phase, amos.Graph):
    ...
    components: amos.Library = amos.Library()
