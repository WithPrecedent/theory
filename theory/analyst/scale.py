...
@dataclasses.dataclass
class MinMaxScale(theory.components.SklearnTransformer):
    """Wrapper for a Technique.
...
scalers = amos.types.Library()


@dataclasses.dataclass
class MaxAbsoluteScale(theory.components.SklearnTransformer):
    """Wrapper for a Technique.
...
@dataclasses.dataclass
class NormalizeScale(theory.components.SklearnTransformer):
    """Wrapper for a Technique.
...
@dataclasses.dataclass
class QuantileScale(theory.components.SklearnTransformer):
    """Wrapper for a Technique.
...
@dataclasses.dataclass
class RobustScale(theory.components.SklearnTransformer):
    """Wrapper for a Technique.
...
@dataclasses.dataclass
class StandardScale(theory.components.SklearnTransformer):
    """Wrapper for a Technique.
...
# @dataclasses.dataclass
# class GaussScale(theory.components.SklearnTransformer):
